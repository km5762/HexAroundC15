...
public class HexAroundFirstSubmission implements IHexAround1{
    ...
    /**
     * Sets the collection of players for this instance.
     * @param players A Collection of Player objects to be set for this instance.
     */
    ...
    /**
     * Sets the board for this instance.
     * @param board A Map of Point and the ICreature the Point contains
     */
    ...
    /**
     * Sets the creatureFactory for this instance.
     * @param creatureFactory An instance of a CreatureFactory
     */
    ...
    public MoveResponse placeCreature(CreatureName creature, int x, int y) {
        ICreature placedCreature = creatureFactory.makeCreature(creature);

        board.put(new Point(x, y), placedCreature);
